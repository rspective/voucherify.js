    ...
    utils: {
      calculatePrice: function (basePrice, voucher) {
        ...
        if (voucher.discount_type === 'PERCENT') {
          ...
          if (!discount || discount < 0 || discount >= basePrice) {
            throw new Error("Invalid voucher, amount discount can't be higher than the price.");
          }

          return roundValue(basePrice - discount, e);
        } else {
